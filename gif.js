    ...
    a.define('/gif.coffee', function(d, m, l, k) {
        ...
        f = a('events', d).EventEmitter, h = a('/browser.coffee', d), e = function(d) {
            ...
            return i(a, d), c = {
                ...
                if (null != this.options.width || this.setOption('width', a.width), null != this.options.height || this.setOption('height', a.height), 'undefined' !== typeof ImageData && null != ImageData && a instanceof ImageData) c.data = a.data;
                ...
                this.running = !0, this.nextFrame = 0, this.finishedFrames = 0, this.imageParts = function(c) {
                    for (var b = function() {
                        ...
                        return b
                    }.apply(this, arguments), a = 0, e = b.length; a < e; ++a) d = b[a], c.push(null);
                    return c
                ...
                for (var c = function() {
                    ...
                    return c
                }.apply(this, arguments), b = 0, e = c.length; b < e; ++b) d = c[b], this.renderNextFrame();
                ...
                var a;
                return a = Math.min(this.options.workers, this.frames.length),
                    function() {
                        var c;
                        c = [];
        ...
        a.prototype.setMaxListeners = function(a) {
            ...
            if (this._events || (this._events = {}), this.emit('newListener', a, b), !this._events[a]) this._events[a] = b;
